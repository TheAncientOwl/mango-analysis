...
export const LoadingsMatrix: React.FC = () => {
  ...
  const [imagePath, setImagePath] = useCache(PCA_CacheKeys.LoadingsMatrixPath, '');

  const allowNext = () => dispatch({ type: ActionType.ChangeCanStep, payload: { index: 6, value: true } });
