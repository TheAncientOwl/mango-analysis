...
import { predict, changeValuesToPredict } from '@store/multiple-linear-regression/actions';
...
const mapState = (state: RootState) => ({
  prediction: state.multipleLinearRegression.prediction,
  valuesToPredict: state.multipleLinearRegression.valuesToPredict,
  independentVariables: state.multipleLinearRegression.independentVariables,
});
