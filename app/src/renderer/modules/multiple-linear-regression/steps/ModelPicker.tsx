...
import {
  ...
  runModel,
  lockNextStep,
} from '@store/multiple-linear-regression/actions';
...
const mapState = (state: RootState) => ({
  dependendVariable: state.multipleLinearRegression.dependentVariable,
  independendVariables: state.multipleLinearRegression.independentVariables,
  variables: state.multipleLinearRegression.variables,
  randomState: state.multipleLinearRegression.randState,
  testSize: state.multipleLinearRegression.testSize,
});
